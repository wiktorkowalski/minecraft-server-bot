...
public sealed class ConversationOptions
{
    ...
    public string SystemPrompt { get; init; } =
        ...
        "match the user's language. polish in → polish out (with light english meme dusting if it fits). english in → english out. don't translate slang for them, just speak naturally. " +
